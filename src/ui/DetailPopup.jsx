// DetailPopup.jsx — Part 8: Real dynamic threat scoring
...
export default function DetailPopup({ event, onClose }) {
  ...
  const geoMap = {
    ...
    "NL": { country: "Netherlands",   region: "W. Europe",      isp: "AS60781 LeaseWeb"    },
    "KR": { country: "South Korea",   region: "Asia Pacific",   isp: "Korea Telecom"       },
    "BR": { country: "Brazil",        region: "South America",  isp: "AS26599 Oi"          },
    "IN": { country: "India",         region: "South Asia",     isp: "AS9829 BSNL"         },
  ...
  const geo = geoMap[cc] || { country: srcName, region: "Unknown Region", isp: "Unknown ISP" };
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: "10px 14px", borderBottom: "1px solid rgba(0,255,136,0.07)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3px 10px" }}>
          {Object.entries(breakdown).map(([factor, pts]) => (
            <div key={factor}>
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: 6, opacity: 0.35, marginBottom: 1 }}>
      ...
      <div style={{ padding: "8px 14px", display: "flex", gap: 5, flexWrap: "wrap", borderBottom: "1px solid rgba(0,255,136,0.07)" }}>
        ...
        {tags.slice(0, 4).map(tag => <Badge key={tag} label={tag.toUpperCase()} color="#00aaff" />)}
      ...
      <div style={{ padding: "2px 14px 10px" }}>
        ...
        <Section title="━━ NETWORK INTELLIGENCE">
          ...
          <Row label="ISP / ASN"   value={geo.isp}                        />
